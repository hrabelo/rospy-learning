...
(cl:defmethod cl:initialize-instance :after ((m <OddEvenCheck-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'OddEvenCheck-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name xihelm_pkg-srv:<OddEvenCheck-request> is deprecated: use xihelm_pkg-srv:OddEvenCheck-request instead.")))

(cl:ensure-generic-function 'number-val :lambda-list '(m))
(cl:defmethod number-val ((m <OddEvenCheck-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader xihelm_pkg-srv:number-val is deprecated.  Use xihelm_pkg-srv:number instead.")
  (number m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<OddEvenCheck-request>)))
  ...
  "xihelm_pkg/OddEvenCheckRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'OddEvenCheck-request)))
  "Returns string type for a service object of type 'OddEvenCheck-request"
  "xihelm_pkg/OddEvenCheckRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <OddEvenCheck-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'OddEvenCheck-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name xihelm_pkg-srv:<OddEvenCheck-response> is deprecated: use xihelm_pkg-srv:OddEvenCheck-response instead.")))

(cl:ensure-generic-function 'answer-val :lambda-list '(m))
(cl:defmethod answer-val ((m <OddEvenCheck-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader xihelm_pkg-srv:answer-val is deprecated.  Use xihelm_pkg-srv:answer instead.")
  (answer m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<OddEvenCheck-response>)))
  ...
  "xihelm_pkg/OddEvenCheckResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'OddEvenCheck-response)))
  "Returns string type for a service object of type 'OddEvenCheck-response"
  "xihelm_pkg/OddEvenCheckResponse")
