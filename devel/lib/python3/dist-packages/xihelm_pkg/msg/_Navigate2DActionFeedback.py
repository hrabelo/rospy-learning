...
"""autogenerated by genpy from xihelm_pkg/Navigate2DActionFeedback.msg. Do not edit."""
import codecs
import sys
...
class Navigate2DActionFeedback(genpy.Message):
  _md5sum = "64688bddd63727e7cd9b419eafcfb8df"
  _type = "xihelm_pkg/Navigate2DActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','xihelm_pkg/Navigate2DFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.feedback is None:
        self.feedback = xihelm_pkg.msg.Navigate2DFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = xihelm_pkg.msg.Navigate2DFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self.feedback.distance_remaining
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.feedback.distance_remaining,) = _get_struct_f().unpack(str[start:end])
      return self
